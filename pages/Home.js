...
const Home = () => {
      ...
      <div className="home__container container grid">
        <div className="home__content grid">
          ...
          <div className="home__social">
            <a href="https://www.linkedin.com/in/aditya-kumar-2581b316a/" target="_blank" rel="noreferrer" className="home__social-icon">
              <i className="uil uil-linkedin-alt"></i>
            </a>
            <a href="https://github.com/adityaxtalk" target="_blank" rel="noreferrer" className="home__social-icon">
  ...
  <p className="home__description">
    ...
    I thrive on solving real-world problems through code and continuously evolving my skills 
   ...
   <div className="home__button-group">
    ...
    <a href="/resume.pdf" download className="button button--flex home__button download">
